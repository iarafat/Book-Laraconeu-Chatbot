...
class SponsorTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Sponsor::insert([
            [
                'name' => 'Nexmo',
                'description' => 'Create innovative and delightful customerexperiences with programmable communication building blocks from Nexmo.',
            ...
            [
                'name' => 'Aimeos','description' => 'High Performance E-Commerce Framework"',
                'image_url' => 'http://screenshots.nomoreencore.com/laracon_sponsors.png',
