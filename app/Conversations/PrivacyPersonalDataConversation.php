...
class PrivacyPersonalDataConversation extends BaseConversation
{
    ...
    private function showPersonalData()
    {
        if ($subscriber = $this->getSubscriberFromCurrentUser()){
            ...
            $this->say('We haven\'t stored any personal data, because you are currently not subscribed to notifications. If you subscribe, we will store only your name and chat ID.');
